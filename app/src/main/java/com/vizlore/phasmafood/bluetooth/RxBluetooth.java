...
import com.vizlore.phasmafood.bluetooth.events.AclEvent;
...
import com.vizlore.phasmafood.bluetooth.events.ServiceEvent;
...
public class RxBluetooth {
	...
	public Observable<BluetoothDevice> observeDevices() {
		...
		return Observable.defer(() -> Observable.create((ObservableOnSubscribe<BluetoothDevice>) emitter -> {
	...
	public Observable<ServiceEvent> observeBluetoothProfile(final int bluetoothProfile) {
		...
		return Observable.defer(() -> Observable.create((ObservableOnSubscribe<ServiceEvent>) emitter -> {
	...
	public Observable<ConnectionStateEvent> observeConnectionState() {
		...
		return Observable.defer(() -> Observable.create((ObservableOnSubscribe<ConnectionStateEvent>) emitter -> {
	...
	public Observable<BondStateEvent> observeBondState() {
		...
		return Observable.defer(() -> Observable.create((ObservableOnSubscribe<BondStateEvent>) emitter -> {
	...
	public Observable<AclEvent> observeAclEvent() {
		...
		return Observable.defer(() -> Observable.create((ObservableOnSubscribe<AclEvent>) emitter -> {
			final BroadcastReceiver receiver = new BroadcastReceiver() {
				@Override
				public void onReceive(Context context, Intent intent) {
					String action = intent.getAction();
